...
Installer le logiciel de configuration Andropod sur le PC, changer l'interface Andropod en ''Configure mode'' (voir figure\ref{fig:ch2_schema}) et la connecter au PC en utilisant un USB câble. Ensuite, on peut éventuellement configurer les autres paramètres avec votre application. 
...
\begin{figure}[!ht]
	\centering
		\includegraphics[width=14cm]{pics/ch2_schema.jpg}
